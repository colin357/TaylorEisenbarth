...
export const metadata: Metadata = {
  title: "Mortgage Calculator Kentucky - Calculate Your Monthly Payment | Taylor Eisenbarth",
  description: "Use our Kentucky mortgage calculator to estimate your monthly payment. Get accurate calculations including property taxes, insurance, and HOA fees for Kentucky homes.",
  keywords: "mortgage calculator Kentucky, Kentucky mortgage calculator, home loan calculator Kentucky, Kentucky home payment calculator, mortgage payment calculator Kentucky",
};

export default function MortgageCalculatorKentucky() {
  return (
    <main className="min-h-screen bg-white">
      ...
      <section className="bg-gradient-to-br from-primary-green/5 via-emerald-50 to-blue-50 py-12">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
            Mortgage Calculator Kentucky: Estimate Your Monthly Payment
          </h1>
          <div className="flex items-center gap-4 text-gray-600 text-sm">
            <span>By Taylor Eisenbarth</span>
            <span>•</span>
            <span>Licensed in Kentucky</span>
          </div>
        </div>
      </section>
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="prose prose-lg max-w-none">
          ...
          <p className="text-xl text-gray-700 leading-relaxed mb-8">
            Want a clearer picture of your Kentucky mortgage payment? This quick guide breaks down the main costs, shows a few local price examples, and highlights the levers that change your total. It’s designed to be scannable so you can get answers fast.
          </p>
          ...
          <div className="bg-gradient-to-r from-primary-green/10 to-emerald-50 border-l-4 border-primary-green p-6 rounded-lg my-8 not-prose">
            ...
            <p className="text-gray-700 mb-4">
              Ready to see exactly what your monthly payment would be? Contact me for a detailed breakdown based on current Kentucky rates and your specific situation.
            </p>
            <Link
              href="/#contact"
          ...
          <div className="grid gap-6 md:grid-cols-2 my-8 not-prose">
            {[
              ...
              },
              {
                ...
                description: "Kentucky’s effective rate averages about 0.87%, with county variations.",
              },
              {
          ...
          <h2 className="text-3xl font-bold text-gray-900 mt-12 mb-6">Kentucky Home Price Overview</h2>

          <p className="text-gray-700 leading-relaxed mb-6">
            Kentucky stays affordable compared to many states. Here’s a quick snapshot:
          </p>
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 my-6 not-prose">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              <div className="rounded-lg bg-white p-4 shadow-sm">
                <p className="text-sm text-gray-500">Kentucky City</p>
          ...
          <div className="bg-gradient-to-r from-primary-green to-emerald-600 text-white p-8 rounded-lg my-12 not-prose">
            <h3 className="text-2xl font-bold mb-4">Let's Calculate Your Exact Kentucky Mortgage Payment</h3>
            <p className="text-lg mb-6">
              As a licensed mortgage professional serving Kentucky, I'll provide you with accurate payment calculations based on current rates, your credit profile, and the specific home you're considering. No guesswork—just real numbers you can count on.
            </p>
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Link
                href="/articles/fha-loan-Kentucky"
      ...
      <section className="bg-gray-50 py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-gray-900 mb-8">Related Kentucky Mortgage Articles</h2>
          <div className="grid md:grid-cols-3 gap-6">
            <Link href="/articles/fha-loan-Kentucky" className="bg-white p-6 rounded-lg shadow-md hover:shadow-xl transition">
              <h3 className="text-xl font-bold text-gray-900 mb-2">FHA Loans in Kentucky</h3>
              <p className="text-gray-600 mb-4">Learn about FHA loan requirements and benefits for Kentucky homebuyers.</p>
              <span className="text-primary-green font-semibold">Read More →</span>
            </Link>
            <Link href="/articles/va-loan-Kentucky" className="bg-white p-6 rounded-lg shadow-md hover:shadow-xl transition">
              <h3 className="text-xl font-bold text-gray-900 mb-2">VA Loans in Kentucky</h3>
              <p className="text-gray-600 mb-4">Explore VA loan benefits for veterans and military members in Kentucky.</p>
              <span className="text-primary-green font-semibold">Read More →</span>
            </Link>
            <Link href="/articles/down-payment-assistance-Kentucky" className="bg-white p-6 rounded-lg shadow-md hover:shadow-xl transition">
              <h3 className="text-xl font-bold text-gray-900 mb-2">Down Payment Assistance Kentucky</h3>
              <p className="text-gray-600 mb-4">Discover programs that help Kentucky first-time homebuyers with down payments.</p>
              <span className="text-primary-green font-semibold">Read More →</span>
            </Link>
          </div>
        </div>
