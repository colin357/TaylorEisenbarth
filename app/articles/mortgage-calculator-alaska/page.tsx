...
export const metadata: Metadata = {
  title: "Mortgage Calculator Alaska - Calculate Your Monthly Payment | Taylor Eisenbarth",
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="prose prose-lg max-w-none">
          ...
          <p className="text-xl text-gray-700 leading-relaxed mb-8">
            Want a clearer picture of your Alaska mortgage payment? This quick guide breaks down the main costs, shows a few local price examples, and highlights the levers that change your total. It’s designed to be scannable so you can get answers fast.
          </p>
          ...
          <div className="grid gap-6 md:grid-cols-2 my-8 not-prose">
            {[
              ...
              },
              {
                ...
                description: "Alaska’s effective rate averages about 0.87%, with county variations.",
              },
              {
          ...
          <p className="text-gray-700 leading-relaxed mb-6">
            Alaska stays affordable compared to many states. Here’s a quick snapshot:
          </p>
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 my-6 not-prose">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              <div className="rounded-lg bg-white p-4 shadow-sm">
                <p className="text-sm text-gray-500">Alaska City</p>
