    ...
    <main className="min-h-screen bg-white">
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="prose prose-lg max-w-none">
          ...
          <p className="text-gray-700 leading-relaxed mb-6">
            Unlike a home equity loan where you receive a lump sum, a HELOC gives you flexibility to borrow only what you need, when you need it. You only pay interest on the amount you actually borrow, not your entire credit limit.
          </p>
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 my-6 not-prose">
            ...
            <ul className="space-y-2 text-gray-700">
              <li>• Current Home Value: $300,000</li>
              <li>• Mortgage Balance: $180,000</li>
              <li>• Maximum CLTV: 85% ($255,000)</li>
              <li>• Available HELOC Amount: $255,000 - $180,000 = <strong>$75,000</strong></li>
            </ul>
          </div>
          ...
          <p className="text-gray-700 leading-relaxed mb-6">
            While this seems high compared to mortgage rates, HELOCs are significantly cheaper than credit cards or personal loans, making them ideal for debt consolidation.
          </p>
          ...
          <p className="text-gray-700 leading-relaxed mb-6">
            HELOCs are ideal for renovation projects:
          </p>
          <ul className="list-disc pl-6 mb-6 text-gray-700 space-y-2">
          ...
          <p className="text-gray-700 leading-relaxed mb-6">
            Fund college tuition or continuing education with lower rates than private student loans.
          </p>
